                    ...
                    <div class="col-lg-3 col-12 mt-3">
                        ...
                        <div class="DEditorsPicksSec mt-3">
                            <div class="DTitleStyle">
                                <a href="https://samakal.com/opinion">
                                    <h3><i class="fa-solid fa-circle-half-stroke"></i>সম্পাদকীয় ও মতামত</h3>
                                </a>
                            </div>
                            <div class="DEditorialListItem">
                                <a href="https://samakal.com/opinion/article/340145/স্থিতি-ও-স্বস্তি-আসুক-এবার">
                                    <div class="row">
                                        <div class="col-lg-7 col-7">
                                            <div class="Desc">
                                                <p class="WriterName"><i class="fa fa-edit" aria-hidden="true"></i>হাসান মামুন </p>
                                                <h2 class="Title"><span class="subHeading">রাজনীতি / </span>স্থিতি ও স্বস্তি আসুক এবার</h2>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-5 ">
                                            <picture>
                                                <img data-src="https://samakal.com/media/imgAll/2026February/SM/hasan-mamun-1771982267.jpg" src="https://samakal.com/media/common/img-300x169.jpg" alt="স্থিতি ও স্বস্তি আসুক এবার" title="স্থিতি ও স্বস্তি আসুক এবার" class="img-fluid img100 ImgRatio">
                                            </picture>
                            ...
                            <div class="DEditorialListItem">
                                <a href="https://samakal.com/opinion/article/340144/জামায়াতের-পুনরুত্থান-এবং-বিএনপির-নতুন-পরীক্ষা">
                                    <div class="row">
                                        <div class="col-lg-7 col-7">
                                            <div class="Desc">
                                                <p class="WriterName"><i class="fa fa-edit" aria-hidden="true"></i>আহম্মদ ফয়েজ</p>
                                                <h2 class="Title"><span class="subHeading">সমকালীন প্রসঙ্গ / </span>জামায়াতের পুনরুত্থান এবং বিএনপির নতুন পরীক্ষা</h2>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-5 ">
                                            <picture>
                                                <img data-src="https://samakal.com/media/imgAll/2026February/SM/untitled-11-1771981971.jpg" src="https://samakal.com/media/common/img-300x169.jpg" alt="জামায়াতের পুনরুত্থান এবং বিএনপির নতুন পরীক্ষা" title="জামায়াতের পুনরুত্থান এবং বিএনপির নতুন পরীক্ষা"
