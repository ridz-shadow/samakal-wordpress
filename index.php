        ...
        <div class="DEditorsPicksSec mt-3">
            <div class="DTitleStyle">
                <a href="<?php echo esc_url( get_category_link( $lead_sidebar_cat_id ) ); ?>">
                    <h3><i class="fa-solid fa-circle-half-stroke"></i><?php echo esc_html( get_cat_name( $lead_sidebar_cat_id ) ); ?></h3>
                </a>
            </div>
...
?></span>
                            ...
                            <div class="col-lg-5 col-5">
                                <picture>
                                    <img data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" alt="<?php the_title; ?>" title="<?php the_title; ?>" class="img-fluid img100 ImgRatio">
                                </picture>
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <a href="<?php the_permalink(); ?>">
                                    <div class="DImgZoomBlock .medium-video-icon">
                                        <picture> <img data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" src="https://samakal.com/media/common/img-300x169.jpg" alt="ওষুধ নিয়ে প্রশ্ন, কার্যকারিতা পরীক্ষা হবে" title="ওষুধ নিয়ে প্রশ্ন, কার্যকারিতা পরীক্ষা হবে"
                                                class="img-fluid img100">
                                        </picture>
                                        <div class="card-video-img"></div>
                                    </div>
                                    <div class="Desc">
                                        <h2 class="Title FW700"><span class="subHeading"><?php echo $shoulder_text; ?></span><?php the_title(); ?></h2>
                                        <div class="Brief">
                            ...
                            <a href="<?php the_permalink(); ?>">
                                    <div class="row">
                                        <div class="col-lg-5 col-5">
                                            <div class="DImgZoomBlock">
                                                <picture>
                                                    <img data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" src="https://samakal.com/media/common/img-300x169.jpg" alt="নগদকে ব্যক্তিখাতে ছাড়ার বিষয়টি সরকারের নীতির ওপর নির্ভর করবে" title="নগদকে ব্যক্তিখাতে ছাড়ার বিষয়টি সরকারের নীতির ওপর নির্ভর করবে"
                                                        class="img-fluid img100">
                                                </picture>
                                            </div>
                                        </div>
